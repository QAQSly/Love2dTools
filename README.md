# FlexLöve v0.11.6 - Default Profile

Slim + Theme and Blur (~95%)

This package contains the **default** build profile of FlexLöve.

## Installation

```bash
unzip flexlove-default-v0.11.6.zip
...
- **modules/** - Default profile modules
- **LICENSE** - MIT License
...
This is the **default** profile. Other profiles available:

...
function ThemeExample:render()
  ...
  local themeSelector = FlexLove.new({
    ...
    width = "100%",
    height = "10%",
    backgroundColor = Color.new(0.18, 0.22, 0.28, 1),
    borderRadius = 8,
  ...
  FlexLove.new({
    ...
    width = "100%",
    height = "50%",
    color = Color.new(0.627, 0.682, 0.752, 1),
  })
  ...
  local statusIndicator = FlexLove.new({
    ...
    width = "100%",
    height = "20%",
    backgroundColor = Color.new(0.29, 0.33, 0.41, 1),
    borderRadius = 8,
  ...
  local statusDot = FlexLove.new({
    ...
    width = 20,
    height = 20,
    backgroundColor = Color.new(0.282, 0.733, 0.471, 1),
    borderRadius = 10,
  })

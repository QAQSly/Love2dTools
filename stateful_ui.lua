...
function StatefulUIExample:render()
  ...
  local toggleSection = FlexLove.new({
    ...
    width = "100%",
    height = "20%",
    backgroundColor = Color.fromHex("#4a5568"),
    borderRadius = 8,
    padding = { horizontal = 15 },
  })
  ...
  local toggleButton = FlexLove.new({
    ...
    width = 60,
    height = 30,
    backgroundColor = self.isToggled and Color.fromHex("#48bb78") or Color.fromHex("#a0aec0"), -- Green when on, gray when off
    borderRadius = 15,
  ...
  FlexLove.new({
    ...
    width = "100%",
    height = "100%",
    color = Color.fromHex("#ffffff"), -- White text
  })
